const ConicBorder = ({ delay = "0s" }: { delay?: string }) => {
    return (
        <>
            ...
            {/* Inset of 2px creates the border width */}
            <div
                className="absolute inset-[1.3px] rounded-[9px] z-10"
                style={{
...
function Card({ title, value, delay = "0s" }: { title: string; value: number; delay?: string }) {
        ...
        <div className="flex flex-col items-center w-24 h-24">
            ...
            <div className="relative w-14 h-14 md:w-20 md:h-20 flex items-center justify-center shadow-lg backdrop-blur-sm rounded-[11px] overflow-hidden">
                ...
                <div className="relative z-20 w-full h-full flex items-center justify-center">
                    ...
                    <p className="bg-gradient-to-b from-[#FDD10E] to-[#F36B24] bg-clip-text text-transparent font-lato font-semibold text-4xl leading-none tracking-tight text-center z-30" style={{ letterSpacing: '-0.02em' }}>
                        {formattedValue}
                    </p>
                </div>
            </div>
...
function CountDownTile() {
    return (
        <div className="relative group cursor-pointer w-32 h-7">
            <div className="relative w-full h-full bg-[#0a0a0a] rounded-[100px] border border-[#FDD10E] flex items-center justify-center">
                <span className="bg-gradient-to-r from-[#FDD10E] to-[#F36B24] bg-clip-text text-transparent font-titillium font-semibold text-6 leading-none tracking-tight text-center" style={{ letterSpacing: '-0.02em' }}>
                    Current Offers
                </span>
            </div>
        </div>
